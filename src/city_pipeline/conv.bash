...
python gml_lod1_extract.py --in ${HEADING_NAME}_extracted --out ${HEADING_NAME}_lod1.json

#python gml2obb.py --in ${HEADING_NAME}_lod1.json --out ${HEADING_NAME}_obb.json
python gml2obb.py --in ${HEADING_NAME}_lod1.json --out ${HEADING_NAME}_obb.json --waste-threshold 1.0 --wall-thickness 0.1
